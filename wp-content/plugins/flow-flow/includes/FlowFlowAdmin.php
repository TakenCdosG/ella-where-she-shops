...
class FlowFlowAdmin {
	...
	public function add_plugin_admin_menu() {
		...
		$this->plugin_screen_hook_suffix = add_menu_page(
			__( 'Flow-Flow — Social Streams Plugin', FlowFlow::$PLUGIN_SLUG ),
			__( 'Flow-Flow', FlowFlow::$PLUGIN_SLUG ),
			'manage_options',
	...
	public function add_action_links( $links ) {
		...
		return array_merge(
			array(
				'settings' => '<a href="' . admin_url( 'options-general.php?page=' . FlowFlow::$PLUGIN_SLUG ) . '">' . __( 'Settings', FlowFlow::$PLUGIN_SLUG ) . '</a>',
				'docs' => '<a target="_blank" href="http://flow.looks-awesome.com/docs/Getting_Started">' . __( 'Documentation', FlowFlow::$PLUGIN_SLUG ) . '</a>'
			),
			$links
		);
	}
	...
	public function render_template($_page, $_data) {
		extract($_data);
		include($_page);
	}
}
