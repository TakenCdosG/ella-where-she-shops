...
<?php if (!empty($styles['wrapperid'])) : ?>
	...
	#<?php echo $styles['wrapperid']; ?> #imgprev<?php echo $unique; ?> { left:0; background:url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAC0AAAA/AQMAAABOytNJAAAABlBMVEUAAAD///+l2Z/dAAAARklEQVQY02OgC1CAUAUQ6geYZPwDppghPPYPYIr/AZiSPwCm7BvAVD1E2z/82hA8ZpgFCH0IU+wboDYQ1vgDxdUKDIMKAAB3vhfQdIYeQwAAAABJRU5ErkJggg=='); left center no-repeat; text-indent:-9999px; }
	#<?php echo $styles['wrapperid']; ?> #imgnext<?php echo $unique; ?> { right:0; background:url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAC0AAAA/AQMAAABOytNJAAAABlBMVEUAAAD///+l2Z/dAAAARklEQVQY02OgB1CAUAUQ6geYZPwD4f2DUPUQyr4BTMkfAFP8D8AU+wcwxUxII4L3D6oSqg9qCtRMqA14tSHcyVAA88PgAgBrzxa2uCvspQAAAABJRU5ErkJggg=='); right center no-repeat; text-indent:-9999px; }
	...
	#<?php echo $styles['wrapperid']; ?> .linkhover {text-indent:-9999px; opacity:.4 !important; filter:alpha(opacity=40) !important; }
