...
<?php if (!empty($styles['wrapperid'])) : ?>
	...
	#<?php echo $styles['wrapperid']; ?> #imgprev<?php echo $unique; ?> { left:10px; background:url('images/arrow-left.png') left center no-repeat; text-indent:-9999px; }
	#<?php echo $styles['wrapperid']; ?> #imgnext<?php echo $unique; ?> { right:10px; background:url('images/arrow-right.png') right center no-repeat; text-indent:-9999px; }
