...
class CustomBannersPlugin extends GoldPlugin
{
	...
	function buildBannerHTML($banner, $banner_id, $atts){
		...
		$html .= '<div class="banners_container" style="border:1px solid #969696 !important; margin:0px 0px 17px  0px  !important; " >';

			$html .= '<div class="banners_title">' . htmlspecialchars($css_class) . '</div>';
			$html .= '<div class="banners_description">';
				if($use_big_link){
					$html .= '<div class="banners_button"><a  href="' . $target_url . '"></a></div>';
				}
				$html .= $img_html;
			...
			$html .= '</div>'; //<!--.banners_description -->
			$html .= '<div class="banners_button"><a href="' . $target_url . '" >' . htmlspecialchars($cta) . '</a></div>';

		$html .= '</div>'; //<!--.banners_container-->
