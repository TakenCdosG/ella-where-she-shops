...
jQuery(document).ready(function($){
	...
	$themifyField.find('.query_category_single').change(function() {
    	...
    	if ( '' != value ) {
			$self.closest('.inside').find('.themify_field_row').removeClass('query-field-hide');
    	} else {
    		$self.closest('.inside').find('.themify_field_row').not('.query-field-visible').addClass('query-field-hide');
    	}
	...
	$('.query_category_single').each(function(){
		var $self = $(this), value = $self.val();
   		if ( '' == value ) {
    		$self.closest('.inside').find('.themify_field_row').not('.query-field-visible').addClass('query-field-hide');
    	}
