...
/***************************************************************************/	
	...
	function themify_page() {
        ...
        <p id="theme-title"><?php echo $check_theme_name; ?> <em><?php echo $check_theme_version; ?> (<a href="http://themify.me/logs/<?php echo '' != $theme->display('Template')? $theme->display('Template') : strtolower($check_theme_name); ?>-changelogs" class="themify_changelogs" target="_blank" data-changelog="http://themify.me/changelogs/<?php echo get_template(); ?>.txt"><?php _e('changelogs', 'themify'); ?></a>)</em></p>
...
function themify_get_font_icons_dialog() {
	...
	$icons = '
		<div id="themify_lightbox_fa" class="themify-admin-lightbox clearfix" style="display: none;">
			...
			' . $wp_filesystem->get_contents( THEMIFY_DIR . '/fontawesome/list.html' ) . '
			</div>
		</div>
