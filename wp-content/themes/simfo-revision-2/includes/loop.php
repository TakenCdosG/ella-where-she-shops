	...
	<div class="post-content">
		...
		<div class="post-date-wrap">
			<?php if($themify->hide_date != "yes"): ?>
				<time datetime="<?php the_time('o-m-d') ?>" class="post-date entry-date updated" itemprop="datePublished"><?php the_time(apply_filters('themify_loop_date', 'M j, Y')) ?> <em>/</em></time>
			<?php endif; //post date ?>
