...
$themify_theme_config['panel']['settings']['tab']['theme_settings'] = array(
	...
	'custom-module' => array(
		...
		array(
			'title' => __('Slider (appears on homepage only)', 'themify'),
			'function' => 'slider'
		),
		array(
...
$themify_theme_config['panel']['styling']['tab']['footer_logo'] = array(
	'title' => __('Footer Logo', 'themify'),
	'id' => 'footer_logo',
	'element' => array(
		array(
			'title' => __('Footer Logo', 'themify'),
		...
		array(
			'title' => __('Footer Logo Hover', 'themify'),
			'id' => 'footer_logo_hover',
			'selector' => '#footer-logo a:hover',
			'module' => array(
				'color',
				'text-decoration'
			)
